...
public class RrdLogger implements Runnable {
    ...
    public static final OtpErlangAtom ATOM_BUSY = new OtpErlangAtom("server_busy");
    ...
    // threads
    private final RrdDbPool rrdDbPool;
    ...
    * Handle updates
    ...
    public static void handleRrdMultiUpdate(
        ...
        RrdLogger.sendReply(caller, ATOM_OK);
    }
    ...
    static class RrdReject implements RejectedExecutionHandler {
        ...
        public void rejectedExecution(final Runnable r, final ThreadPoolExecutor e) {
            ...
            RrdLogger.sendReply(failRunner.getCaller(), RrdLogger.ATOM_BUSY);
        }
    }
}
